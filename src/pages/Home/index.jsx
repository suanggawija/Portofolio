...
const Home = () => {
  return (
    <div className='w-full md:h-screen flex items-center gap-16 px-6 md:px-44 mb-16 md:mb-0' id='home' >
        <div className='md:grid md:grid-cols-3 flex flex-col-reverse'>
            <div className='md:col-span-2 text-center md:text-left md:mt-0 mt-6'>
