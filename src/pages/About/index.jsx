...
const About = () => {
  return (
    <>
        <div className='md:h-screen flex flex-col pt-32 items-center' id='about'>
            <Heading heading={'Teantang Saya'}/>
            <div className='py-8'><img src={Profile} alt="" className='w-48' /></div>
            <div className='md:w-7/12 w-10/12 pt-6 pb-12 text-center'>
        ...
        <div className='md:h-screen text-center flex flex-col items-center justify-center pt-32 pb-24 md:pb-0 md:pt-0'>
            <Heading heading={'Keahlian Saya'}/>
            <div className='grid md:grid-cols-5 grid-cols-3 gap-3 md:gap-8 px-12 md:px-52 pt-12'>
                <SkillBox image={Html}/>
                <SkillBox image={Css}/>
